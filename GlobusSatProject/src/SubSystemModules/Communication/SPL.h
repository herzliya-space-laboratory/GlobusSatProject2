...
typedef enum __attribute__ ((__packed__)) ack_subtype_t
{
	...
	ACK_GET_ALPHA = 0x40,
	ACK_GET_EPS_THRESHOLDS = 0x41,
	ACK_GET_STATE = 0x42,
	ACK_GET_HEATER_THRESHOLD = 0x43,
	ACK_GET_FREE_SPACE = 0x44,
	ACK_GET_TLM_SAVE_PERIODS = 0x45,
	ACK_GET_SAT_TIME = 0x46,
	ACK_GET_SAT_UPTIME = 0x47,
	ACK_GET_GROUND_WDT = 0x48,
	ACK_GET_RSSI_VALUE = 0x49,
	ACK_GET_BEACON_INTERVAL = 0x4A,
	ACK_GET_TX_UPTIME = 0x4B,
	ACK_GET_RX_UPTIME = 0x4C,
	ACK_GET_ANTS_UPTIME = 0x4D,
